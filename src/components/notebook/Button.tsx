...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 font-hand font-medium select-none " +
    ...
    "focus-visible:ring-3 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-paper",
  {
    variants: {
      ...
      size: {
        sm: "h-9 px-3 text-sm rounded-[10px_14px_8px_12px]",
        md: "h-11 px-5 text-base rounded-[12px_16px_10px_14px]",
        lg: "h-14 px-7 text-lg rounded-[14px_20px_12px_18px]",
